...
mod1 <- lm(ADM_RATE ~ CONTROL+HBCU+PBI+TRIBAL+WOMENONLY+COSTT4_A+AVGFACSAL+PFTFAC+PCTPELL+UG25ABV+
            INC_PCT_LO+PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+PCT_BLACK+PCT_ASIAN+PCT_HISPANIC+
            PCT_BA+PCT_GRAD_PROF+PCT_BORN_US+POVERTY_RATE+UNEMP_RATE, data=data) 
summary(mod1)

mod2 <- lm(ADM_RATE ~ CONTROL+PBI+TRIBAL+WOMENONLY+COSTT4_A+AVGFACSAL+PFTFAC+PCTPELL+UG25ABV+
            INC_PCT_LO+PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+PCT_BLACK+PCT_ASIAN+PCT_HISPANIC+
            PCT_BA+PCT_GRAD_PROF+PCT_BORN_US+POVERTY_RATE+UNEMP_RATE, data=data) 
summary(mod2)

mod3 <- lm(ADM_RATE ~ CONTROL+AVGFACSAL+PFTFAC+PCTPELL+UG25ABV+
            INC_PCT_LO+PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+PCT_BLACK+PCT_ASIAN+PCT_HISPANIC+
            PCT_BA+PCT_GRAD_PROF+PCT_BORN_US+POVERTY_RATE+UNEMP_RATE, data=data) 
summary(mod3)

mod4 <- lm(ADM_RATE ~ CONTROL+AVGFACSAL+PFTFAC+
            PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+PCT_BLACK+PCT_ASIAN+PCT_HISPANIC+
            PCT_BA+PCT_GRAD_PROF+PCT_BORN_US+POVERTY_RATE+UNEMP_RATE, data=data) 
summary(mod4)

mod5 <- lm(ADM_RATE ~ CONTROL+AVGFACSAL+PFTFAC+
            PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+
            PCT_BA+PCT_GRAD_PROF+PCT_BORN_US+POVERTY_RATE+UNEMP_RATE, data=data) 
summary(mod5)

mod6 <- lm(ADM_RATE ~ CONTROL+AVGFACSAL+PFTFAC+
            PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+
...
pairs(~ CONTROL+AVGFACSAL+PFTFAC+PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+PCT_BA+PCT_GRAD_PROF, data = data)
plot(data$ADM_RATE ~ fitted(mod6), main="Y versus Y-hat", xlab="Y-hat", ylab="Y")
abline(a = 0, b = 1)
lines(lowess(data$ADM_RATE ~ fitted(mod6)), lty=2)

plot(r ~ fitted(mod6), main = "Residuals vs fittedADM_RATE", xlab = "fittedADM_RATE", ylab = "residuals")
...
plot(r ~ data$UNEMP_RATE, main = "Residuals vs UNEMP_RATE", xlab = "UNEMP_RATE", ylab = "residuals")
...
p <- powerTransform(cbind(data[,6],data[,16],data[,20],data[,21],data[,22],data[,23],data[,27],data[,28],data[,30],data[,31])~1)
summary(p)

p <- powerTransform(cbind(data[,6],data[,13],data[,16],data[,20],data[,21],data[,22],data[,23],data[,27],data[,28],data[,30],data[,31])~1)
summary(p)
```
8.Transformation
```{r}
finalmod <- lm(((ADM_RATE)**2) ~ CONTROL+AVGFACSAL+PFTFAC+
            PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+
            PCT_BA+PCT_GRAD_PROF+POVERTY_RATE+UNEMP_RATE,data=data)
summary(finalmod)

mod7 <- lm(sqrt(ADM_RATE) ~ CONTROL+AVGFACSAL+PFTFAC+
            PAR_ED_PCT_1STGEN+FEMALE+MD_FAMINC+PCT_WHITE+
            PCT_BA+PCT_GRAD_PROF+POVERTY_RATE+UNEMP_RATE,data=data)
summary(mod7)
```
...
plot(r1 ~ fitted(finalmod), main = "Residuals vs fittedADM_RATE", xlab = "fittedADM_RATE", ylab = "residuals")
plot(r1 ~ data$CONTROL, main = "Residuals vs Control", xlab = "Control", ylab = "residuals")
plot(r1 ~ data$AVGFACSAL, main = "Residuals vs AVGFACSAL", xlab = "AVGFACSAL", ylab = "residuals")
plot(r1 ~ data$PAR_ED_PCT_1STGEN, main = "Residuals vs PAR_ED_PCT_1STGEN", xlab = "PAR", ylab = "residuals")
plot(r1 ~ data$FEMALE, main = "Residuals vs female", xlab = "female", ylab = "residuals")
plot(r1 ~ data$MD_FAMINC, main = "Residuals vs MD_FAMINC", xlab = "MD_FAMINC", ylab = "residuals")
plot(r1 ~ data$PCT_WHITE, main = "Residuals vs PCT_WHITE", xlab = "PCT_WHITE", ylab = "residuals")
plot(r1 ~ data$PCT_BA, main = "Residuals vs PCT_BA", xlab = "PCT_BA", ylab = "residuals")
plot(r1 ~ data$PCT_GRAD_PROF, main = "Residuals vs PCT_GRAD_PROF", xlab = "PCT_GRAD_PROF", ylab = "residuals")
plot(r1 ~ data$POVERTY_RATE, main = "Residuals vs PVERTY_RATE", xlab = "POVERTY_RATE", ylab = "residuals")
plot(r1 ~ data$UNEMP_RATE, main = "Residuals vs UNEMP_RATE", xlab = "UNEMP_RATE", ylab = "residuals")
...
r2 <- resid(mod7)
plot(data$ADM_RATE ~ fitted(mod7), main="Y versus Y-hat", xlab="Y-hat", ylab="Y")
abline(a = 0, b = 1)


plot(r2 ~ fitted(mod7), main = "Residuals vs fittedADM_RATE", xlab = "fittedADM_RATE", ylab = "residuals")
plot(r2 ~ data$CONTROL, main = "Residuals vs Control", xlab = "Control", ylab = "residuals")
plot(r2 ~ data$AVGFACSAL, main = "Residuals vs AVGFACSAL", xlab = "AVGFACSAL", ylab = "residuals")
plot(r2 ~ data$PAR_ED_PCT_1STGEN, main = "Residuals vs PAR_ED_PCT_1STGEN", xlab = "PAR", ylab = "residuals")
plot(r2 ~ data$FEMALE, main = "Residuals vs female", xlab = "female", ylab = "residuals")
plot(r2 ~ data$MD_FAMINC, main = "Residuals vs MD_FAMINC", xlab = "MD_FAMINC", ylab = "residuals")
plot(r2 ~ data$PCT_WHITE, main = "Residuals vs PCT_WHITE", xlab = "PCT_WHITE", ylab = "residuals")
plot(r2 ~ data$PCT_BA, main = "Residuals vs PCT_BA", xlab = "PCT_BA", ylab = "residuals")
plot(r2 ~ data$PCT_GRAD_PROF, main = "Residuals vs PCT_GRAD_PROF", xlab = "PCT_GRAD_PROF", ylab = "residuals")
plot(r2 ~ data$POVERTY_RATE, main = "Residuals vs PVERTY_RATE", xlab = "POVERTY_RATE", ylab = "residuals")
plot(r2 ~ data$UNEMP_RATE, main = "Residuals vs UNEMP_RATE", xlab = "UNEMP_RATE", ylab = "residuals")
